...
class AppColors {
  ...
  static const appTheme = Color.fromRGBO(240, 196, 84, 1);
  static const appBackground = Color.fromRGBO(223, 237, 239, 1);
  static final buttonBlue = const Color.fromRGBO(19, 31, 84, 1);
  static final buttonBlueShadow = const Color.fromRGBO(60, 76, 146, 0.85);
  static final buttonBlueShadowlight = const Color.fromRGBO(60, 76, 146, 0.29);
  static final loginWelcome = const Color.fromRGBO(22, 29, 60, 1);
  static final logininfo = const Color.fromRGBO(28, 30, 38, 1);
  static final smallButton = const Color.fromRGBO(255, 255, 255, 0.9);
  static final smallButtonShadow = const Color.fromRGBO(0, 0, 0, 0.08);
  static final featuresChipShadow = const Color.fromRGBO(112, 112, 112, 0.35);
  static final smallButtonBorder = const Color.fromRGBO(80, 80, 80, 0.2);
  static final smallButtonText = const Color.fromRGBO(16, 17, 20, 1);
  static final smallOfficeSizeText = const Color.fromRGBO(122, 122, 122, 1);
  static final officeDetailText = const Color.fromRGBO(49, 49, 49, 1);
  static final seminarGradient2 = const Color.fromRGBO(35, 35, 35, 0.58);
  static final seminarGradient3 = const Color.fromRGBO(84, 84, 84, 0);
  static final senderRowBlueColor = const Color.fromRGBO(60, 76, 146, 0.91);
  ...
  static const clrLightBlack = Color.fromRGBO(29, 29, 29, 1);
  ...
  static final veryLightGreyTextColor = const Color.fromRGBO(153, 153, 153, 1);
  static final purpleColorText = const Color.fromRGBO(22, 29, 60, 1);
  static final sendMessageConatinerBG = const Color.fromRGBO(214, 215, 220, 1);

  static final blackLightTextColor = const Color.fromRGBO(28, 30, 38, 1);
  static final navyBlueColor = const Color.fromRGBO(93, 156, 211, 1);
}